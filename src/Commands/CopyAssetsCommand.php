...
namespace Victorycodedev\NativephpFetch\Commands;

use Native\Mobile\Plugins\Commands\NativePluginHookCommand;

/**
 * Copy assets hook command for Fetch plugin.
 *
...
{
    protected $signature = 'nativephp:fetch:copy-assets';

    protected $description = 'Copy assets for Fetch plugin';
    ...
    protected function copyAndroidAssets(): void
    {
        ...
        $this->info('Android assets copied for Fetch');
    }
    ...
    protected function copyIosAssets(): void
    {
        ...
        $this->info('iOS assets copied for Fetch');
    }
}
